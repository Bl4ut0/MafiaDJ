...
# Install build tools for native npm modules (better-sqlite3)
...
# Install runtime dependencies: ffmpeg, python3, curl, ca-certificates, wget, tar, libasound2, librespot
